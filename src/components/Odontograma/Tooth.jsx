  ...
  render(props) {
    return (
      <div
        ...
        className={
          this.props.data.css ? `boxTooth ${this.props.data.css}` : "boxTooth"
        }
      >
        {this.props.data.status ? (
          <button
            className="removeButton"
            onClick={() => this.props.toggleTooth(this.props.data)}
          >
            -
          </button>
        ) : (
        ...
        <svg
          ...
          className={this.props.data.status ? "tooth" : "tooth disabled"}
        >
          <polygon
            stroke="blue"
